...
public class DBManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(GetRequest("http://localhost/HomeMakerz/GetImage.php"));
   }
                ...
                case UnityWebRequest.Result.Success:
                    ...
                    for(int i = 0; i < users.Length; i++)
                    {
                        ...
                        if(users[i] != "")
                        {
                            ...
                            Debug.Log("Product: " + userinfo[0] + "Price: " + userinfo[1]);
                            imageString = userinfo[2];
                            ...
                            gobj.GetComponent<DBInfo>().image.sprite = imgSprite;                            
                            gobj.GetComponent<DBInfo>().productName.text = userinfo[0];
                            gobj.GetComponent<DBInfo>().price.text = userinfo[1];                            
                        }
                    }
